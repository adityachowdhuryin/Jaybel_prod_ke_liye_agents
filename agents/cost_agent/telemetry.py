"""
Phase 2 observability: export FastAPI request traces to Google Cloud Trace when enabled.
...
def setup_observability(app: FastAPI, service_name: str) -> None:
    ...
    logger.info("Cloud Trace enabled for service=%s project=%s", service_name, project)
